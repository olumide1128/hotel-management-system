...
urlpatterns = [
    ...
    path("process_guest_detail/", views.handle_ajax_request2, name="process_guest_detail"),
    ...
    path("admin_billing/", views.admin_billing_view, name="adminBilling"),
    path("clean/<int:id>", views.clean_room_view, name="cleanRoom"),
    path("delete_bill/<int:id>", views.delete_bill_view, name="deleteBill"),
    path("invoice/<int:id>", views.invoice_view, name="guestInvoice"),
]